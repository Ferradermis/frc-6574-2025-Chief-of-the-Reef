...
public final class Constants {
  ...
  public static final class PositionConstants {
    ...
    public static final double ALGAE_ONE_ELEVATOR_HEIGHT = 6.5 * 39.37; 
    public static final double ALGAE_TWO_ELEVATOR_HEIGHT = 12.5 * 39.37;
    public static final double ALGAE_GROUND_ELEVATOR_HEIGHT = 2.3825 * 39.87; 
    public static final double CORAL_GROUND_ELEVATOR_HEIGHT = 3.140 * 39.87;
    ...
    public static final double ALGAE_ONE_PIVOT_ANGLE = 0.06;
    public static final double ALGAE_TWO_PIVOT_ANGLE = 0.075;
