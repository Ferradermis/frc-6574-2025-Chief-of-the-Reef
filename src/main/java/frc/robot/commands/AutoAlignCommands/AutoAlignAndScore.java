...
public class AutoAlignAndScore extends SequentialCommandGroup {
  ...
  Map<ReefPositions.ReefLevel, Command> reefLevelCommands = SelectorCommandFactory.getReefLevelCommandSelector();
  Map<ReefPositions.ReefLevel, Command> reefScoringCommands = SelectorCommandFactory.getReefLevelScoringCommandSelector();
