...
public class PivotIONEO implements PivotIO {
  ...
  public void configureNEO() {
    ...
    m_pivotConfig
        ...
        .positionConversionFactor(
            1) // TODO: Find correct conversion factor - defaulted at 1 for now :)
    ...
    m_pivotConfig
        ...
        .feedbackSensor(
            FeedbackSensor
                .kPrimaryEncoder) // TODO: Find correct feedback sensor - defaulted at primary
        // encoder for now :)
        .pid(
            0.1, 0,
            0) // using default slot 0 for this NEO - we will probably not use this slot much or at
        // all
        ...
        .pid(
            ...
            0,
            0,
            ClosedLoopSlot.kSlot1) // TODO: Find correct PID values - defaulted at 0 for now :)
        .velocityFF(
            0,
            ClosedLoopSlot
                .kSlot1) // TODO: Find correct velocity feedforward value - defaulted at 0 for now
        // :)
  ...
  public void updateInputs(PivotInputs inputs) {
    ...
    inputs.pivotAngularVelocity.mut_replace(
        m_pivotMotor.getEncoder().getVelocity(), RotationsPerSecond);
    inputs.pivotSetPoint.mut_replace(
        Angle.ofRelativeUnits(m_pivotMotor.getAppliedOutput(), Rotations));
